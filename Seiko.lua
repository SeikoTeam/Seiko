...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"˹𝗦𝙚𝙞𝘬𝐎  ")  
...
os.execute('wget https://raw.githubusercontent.com/SeikoTeam/Seiko/main/Seiko.lua')
...
if Devmode(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Seiko-TEAM/Files_Seiko/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n • اهلا بك في متجر ملفات سايكو\n • ملفات السورس ↓\n⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆\n\n"
local TextE = "\n⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆\n • علامة تعني { ✔️ } ملف مفعل\n • علامة تعني { ✖ } ملف معطل\n • قناة سورس سايكو ↓\n".." • [اضغط هنا لدخول](t.me/llllrc) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Seiko-TEAM/Files_Seiko/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('Seiko.lua')  
else
send(msg.chat_id_, msg.id_," • عذرا الملف لايدعم سورس سايكو \n") 
end
return false
end
